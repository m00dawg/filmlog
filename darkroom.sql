...
CREATE TABLE Papers(
    ...
    name varchar(64),
    KEY paperBrandsID_fk (paperBrandsID),
    CONSTRAINT papers_paperBrandsID FOREIGN KEY (paperBrandsID) REFERENCES PaperBrands (paperBrandID) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE='InnoDB';

INSERT INTO Papers (paperBrandsID, type, grade, surface, tone, name)
